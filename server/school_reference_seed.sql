...
SET
  subject_name_zh = CASE TRIM(subject_name)
    ...
    WHEN '設計與應用科技' THEN '設計與應用科技'
    WHEN 'Design and Applied Technology' THEN '設計與應用科技'
    WHEN 'DAT' THEN '設計與應用科技'
    WHEN '中國歷史' THEN '中國歷史'
    WHEN 'CHIS' THEN '中國歷史'
    ...
    WHEN '旅遊與款待' THEN '旅遊與款待'
    WHEN 'Tourism and Hospitality Studies' THEN '旅遊與款待'
    WHEN '體育' THEN '體育'
  ...
  subject_name_en = CASE TRIM(subject_name)
    WHEN '中國語文' THEN 'Chinese Language'
    ...
    WHEN '設計與應用科技' THEN 'Design and Applied Technology'
    WHEN 'Design and Applied Technology' THEN 'Design and Applied Technology'
    WHEN 'DAT' THEN 'Design and Applied Technology'
    WHEN '中國歷史' THEN 'Chinese History'
    ...
    WHEN '倫理與宗教' THEN 'Ethics and Religious Education'
    WHEN 'E&RE' THEN 'Ethics and Religious Education'
    WHEN 'RE' THEN 'Ethics and Religious Education'
    WHEN 'RS' THEN 'Ethics and Religious Education'
    WHEN 'Religious Education' THEN 'Ethics and Religious Education'
    WHEN '科技與生活' THEN 'Technology and Living'
    ...
    WHEN 'MUS' THEN 'Music'
    WHEN '歷史' THEN 'History'
    WHEN 'History' THEN 'History'
    WHEN 'HIST' THEN 'History'
    WHEN 'HIST-B1' THEN 'History'
    WHEN '視覺藝術' THEN 'Visual Arts'
    WHEN 'Visual Arts' THEN 'Visual Arts'
    WHEN 'VA' THEN 'Visual Arts'
    WHEN 'VAD-B2' THEN 'Visual Arts'
    WHEN '旅遊與款待' THEN 'Tourism and Hospitality Studies'
    WHEN 'Tourism and Hospitality Studies' THEN 'Tourism and Hospitality Studies'
    WHEN '體育' THEN 'Physical Education'
